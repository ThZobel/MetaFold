...
const omeroUIIntegration = {
    ...
    init() {
        ...
        console.log('🔬 OMERO UI Integration initialized');
        return true;
    },
    ...
    // Enhanced connection test with UI feedback
    async testConnection() {
        try {
            ...
            console.log('🔬 === OMERO CONNECTION TEST (UI INTEGRATION) ===');
            ...
            const connectionResult = await window.omeroAuth.testConnectionEnhanced();
    ...
    async createDatasetForProject(projectName, metadata = null, options = {}) {
        ...
        try {
            ...
            return await window.omeroDatasetCreation.createDatasetForProject(projectName, metadata, options);
        } catch (error) {
            return {
                success: false,
...
// Global handlers for OMERO Group and Project selection
...
// Update OMERO options visibility
window.updateOMEROOptions = function() {
    if (window.omeroUIIntegration && window.omeroUIIntegration.updateOptionsVisibility) {
        window.omeroUIIntegration.updateOptionsVisibility();
    }
};
...
console.log('✅ OMERO UI Integration loaded (Complete UI Management)');