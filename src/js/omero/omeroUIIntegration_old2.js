// OMERO UI Integration Module - FIXED VERSION
...
const omeroUIIntegration = {
    ...
    init() {
        ...
        console.log('🔬 OMERO UI Integration initialized (FIXED VERSION)');
        return true;
    },
...
console.log('✅ OMERO UI Integration loaded (FIXED VERSION - Corrected function calls)');