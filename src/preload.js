...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    importTemplatesFromFile: (importType = 'single') =>
        ipcRenderer.invoke('import-templates-from-file', importType),
    ...
    // =================== LIFECYCLE EVENT LISTENERS (Phase 5.2) ===================
    ...
    // Remove app-closing listener
    removeAppClosingListener: (callback) => {
        ipcRenderer.removeListener('app-closing', callback);
    },
